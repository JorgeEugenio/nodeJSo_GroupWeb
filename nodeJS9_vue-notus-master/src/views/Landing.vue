            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Diseño Web</h6>
            ...
            <div class="w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Branding para marcas</h6>
                  <!-- <p class="mt-2 mb-4 text-gray-600">
            ...
            <div class="pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Publicidad Digital</h6>
                  <!-- <p class="mt-2 mb-4 text-gray-600">
            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Posicionamiento Web</h6>
                  <!-- <p class="mt-2 mb-4 text-gray-600">
                    Divide details about your product or agency work into parts.
                    A paragraph describing a feature will be enough.
                  </p> -->
            ...
            <div class= "w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Estrategia de Marketing digital</h6>
                  <!-- <p class="mt-2 mb-4 text-gray-600">
                    Keep you user engaged by providing meaningful information.
                    Remember that by this time, the user is curious.
                  </p> -->
            ...
            <div class="pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">Desarrollo de aplicaciones moviles</h6>
                  <!-- <p class="mt-2 mb-4 text-gray-600">
                    Write a few lines about each one. A paragraph describing a
                    feature will be enough. Keep you user engaged!
                  </p> -->
          ...
          <div class="items-center flex flex-wrap">
            ...
            <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <h3 class="text-3xl font-semibold">Una compañia en crecimiento</h3>
        ...
        <div class="container mx-auto px-4">
          <div class="flex flex-wrap justify-center text-center mb-24">
            <div class="w-full lg:w-6/12 px-4">
              <h2 class="text-4xl font-semibold">Aquí nuestro Team</h2>
          ...
          <div class="flex flex-wrap">
            <div class="w-full md:w-6/12 lg:w-4/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                ...
                <div class="pt-6 text-center">
                  <h5 class="text-xl font-bold">Alex Ramos</h5>
            ...
            <div class="w-full md:w-6/12 lg:w-4/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                ...
                />
                <div class="pt-6 text-center">
                  <h5 class="text-xl font-bold">Jorge Eugenio</h5>
                  <p class="mt-1 text-sm text-gray-500 uppercase font-semibold">
                    UI/UX Designer
                  </p>
                  <div class="mt-6">
            ...
            <div class="w-full md:w-6/12 lg:w-4/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                ...
                />
                <div class="pt-6 text-center">
                  <h5 class="text-xl font-bold">Ronald Chavez</h5>
                  <p class="mt-1 text-sm text-gray-500 uppercase font-semibold">
...
import team1 from "@/assets/img/alex.png";
import team2 from "@/assets/img/jorge.png";
import team3 from "@/assets/img/ronald.jpg";
